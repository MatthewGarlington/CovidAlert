            ...
            ZStack(alignment: .bottomLeading) {
                ...
                HStack {
                    VStack(alignment: .leading) {
                        ...
                        Text(vm.nytimesnews?.response.docs[choice].headline.print_headline ?? title)
...
//                        vm.nytimesnews?.response.docs[0].headline.print_headline ??
                    ...
                    Text(vm.nytimesnews?.response.docs[choice].byline.original ?? author)
                        .foregroundColor(.white)
...
//                    vm.nytimesnews?.response.docs[0].byline.original ??
            ...
            VStack(alignment: .leading, spacing: 8){
                Text(vm.nytimesnews?.response.docs[choice].headline.main ?? title)
...
//                vm.nytimesnews?.response.docs[0].headline.main ??
            ...
            Text(vm.nytimesnews?.response.docs[choice].lead_paragraph ?? content)
                .frame(height: 350)
                .padding(.top, 8)
