...
//                vm.nytimesnews?.response.docs[0].headline.main ??
            ...
            Text(vm.nytimesnews?.response.docs[3].lead_paragraph ?? content)
                .frame(height: 350)
                .padding(.top, 8)
...
struct NewsDetailView3_Previews: PreviewProvider {
