...
struct ARDetailView: View {
    @ObservedObject var vm = ARDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Arkansas", displayMode: .inline)
...
struct ARDetailView_Previews: PreviewProvider {
