...
struct CODetailView: View {
    @ObservedObject var vm = CODetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Colorado", displayMode: .inline)
...
struct CODetailView_Previews: PreviewProvider {
