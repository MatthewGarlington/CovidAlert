...
struct DCDetailView: View {
    @ObservedObject var vm = DCDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            GeometryReader { proxy in
                ScrollView {
                    ...
                    VStack {
                        ...
                        StateNewsView()
                    }.navigationTitle("District of Columbia")
            ...
            .cornerRadius(7)
        }.navigationBarTitle("District of Columbia", displayMode: .inline)
...
struct DCDetailView_Previews: PreviewProvider {
