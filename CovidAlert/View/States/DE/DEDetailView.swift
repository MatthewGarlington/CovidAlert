...
struct DEDetailView: View {
    @ObservedObject var vm = DEDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Delaware", displayMode: .inline)
...
struct DEDetailView_Previews: PreviewProvider {
