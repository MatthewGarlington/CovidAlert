...
struct FLDetailView: View {
    @ObservedObject var vm = FLDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Florida", displayMode: .inline)
...
struct FLDetailView_Previews: PreviewProvider {
