...
struct GADetailView: View {
    @ObservedObject var vm = GADetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Georgia", displayMode: .inline)
...
struct GADetailView_Previews: PreviewProvider {
