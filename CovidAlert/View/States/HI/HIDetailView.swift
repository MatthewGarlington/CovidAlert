...
struct HIDetailView: View {
    @ObservedObject var vm = HIDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Hawaii", displayMode: .inline)
...
struct HIDetailView_Previews: PreviewProvider {
