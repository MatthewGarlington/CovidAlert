...
struct IADetailView: View {
    @ObservedObject var vm = IADetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Iowa", displayMode: .inline)
...
struct IADetailView_Previews: PreviewProvider {
