...
struct KSDetailView: View {
    @ObservedObject var vm = KSDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Kansas", displayMode: .inline)
...
struct KSDetailView_Previews: PreviewProvider {
