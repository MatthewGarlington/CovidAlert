...
struct KYDetailView: View {
    @ObservedObject var vm = KYDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Kentucky", displayMode: .inline)
...
struct KYDetailView_Previews: PreviewProvider {
