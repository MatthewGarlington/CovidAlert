...
struct LADetailView: View {
    @ObservedObject var vm = LADetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Louisiana", displayMode: .inline)
...
struct LADetailView_Previews: PreviewProvider {
