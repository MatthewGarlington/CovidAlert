...
struct MADetailView: View {
    @ObservedObject var vm = MADetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Massachusetts", displayMode: .inline)
...
struct MADetailView_Previews: PreviewProvider {
