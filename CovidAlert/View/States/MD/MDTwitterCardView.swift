...
struct MDTwitterCardView: View {
    let twitterDecoded = Bundle.main.decode("MarylandHealth.json")
...
struct MDTwitterCardView_Previews: PreviewProvider {
