...
struct MIDetailView: View {
    @ObservedObject var vm = MIDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Michigan", displayMode: .inline)
...
struct MIDetailView_Previews: PreviewProvider {
