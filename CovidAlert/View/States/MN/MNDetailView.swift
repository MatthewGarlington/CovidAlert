...
struct MNDetailView: View {
    @ObservedObject var vm = MNDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Minnesota", displayMode: .inline)
...
struct MNDetailView_Previews: PreviewProvider {
