...
struct MSDetailView: View {
    @ObservedObject var vm = MSDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Mississippi", displayMode: .inline)
...
struct MSDetailView_Previews: PreviewProvider {
