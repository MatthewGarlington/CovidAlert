...
struct MTDetailView: View {
    @ObservedObject var vm = MTDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Montana", displayMode: .inline)
...
struct MTDetailView_Previews: PreviewProvider {
