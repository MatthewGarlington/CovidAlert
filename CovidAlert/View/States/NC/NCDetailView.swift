...
struct NCDetailView: View {
    @ObservedObject var vm = NCDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            GeometryReader { proxy in
                ScrollView {
                    ...
                    VStack {
                        ...
                        StateNewsView()
                    }.navigationTitle("North Carolina")
            ...
            .cornerRadius(7)
        }.navigationBarTitle("North Carolina", displayMode: .inline)
...
struct NCDetailView_Previews: PreviewProvider {
