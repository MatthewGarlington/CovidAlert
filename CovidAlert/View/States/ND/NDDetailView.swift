...
struct NDDetailView: View {
    @ObservedObject var vm = NDDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("North Dakota", displayMode: .inline)
...
struct NDDetailView_Previews: PreviewProvider {
