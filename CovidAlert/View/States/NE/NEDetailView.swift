...
struct NEDetailView: View {
    @ObservedObject var vm = NEDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Nebraska", displayMode: .inline)
...
struct NEDetailView_Previews: PreviewProvider {
