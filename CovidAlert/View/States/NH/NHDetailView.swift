...
struct NHDetailView: View {
    @ObservedObject var vm = NHDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("New Hampshire", displayMode: .inline)
...
struct NHDetailView_Previews: PreviewProvider {
