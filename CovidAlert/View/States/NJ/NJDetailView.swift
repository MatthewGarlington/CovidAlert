...
struct NJDetailView: View {
    @ObservedObject var vm = NJDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("New Jersey", displayMode: .inline)
...
struct NJDetailView_Previews: PreviewProvider {
