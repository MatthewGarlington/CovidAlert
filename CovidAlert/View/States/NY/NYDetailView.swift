...
struct NYDetailView: View {
    @ObservedObject var vm = NYDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("New York", displayMode: .inline)
...
struct NYDetailView_Previews: PreviewProvider {
