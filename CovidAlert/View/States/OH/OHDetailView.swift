...
struct OHDetailView: View {
    @ObservedObject var vm = OHDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Ohio", displayMode: .inline)
...
struct OHDetailView_Previews: PreviewProvider {
