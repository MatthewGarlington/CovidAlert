...
struct ORDetailView: View {
    @ObservedObject var vm = ORDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Oregon", displayMode: .inline)
...
struct ORDetailView_Previews: PreviewProvider {
