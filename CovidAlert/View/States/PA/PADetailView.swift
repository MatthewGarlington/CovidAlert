...
struct PADetailView: View {
    @ObservedObject var vm = PADetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Pennsylvania", displayMode: .inline)
...
struct PADetailView_Previews: PreviewProvider {
