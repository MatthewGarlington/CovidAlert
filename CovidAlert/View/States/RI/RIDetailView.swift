...
struct RIDetailView: View {
    @ObservedObject var vm = RIDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Rhode Island", displayMode: .inline)
...
struct RIDetailView_Previews: PreviewProvider {
