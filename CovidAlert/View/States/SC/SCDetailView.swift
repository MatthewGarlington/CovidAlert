...
struct SCDetailView: View {
    @ObservedObject var vm = SCDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            GeometryReader { proxy in
                ScrollView {
                    ...
                    VStack {
                        ...
                        StateNewsView()
                    }.navigationTitle("South Carolina")
            ...
            .cornerRadius(7)
        }.navigationBarTitle("South Carolina", displayMode: .inline)
...
struct SCDetailView_Previews: PreviewProvider {
