...
struct SDDetailView: View {
    @ObservedObject var vm = SDDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("South Dakota", displayMode: .inline)
...
struct SDDetailView_Previews: PreviewProvider {
