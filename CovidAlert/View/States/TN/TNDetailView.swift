...
struct TNDetailView: View {
    @ObservedObject var vm = TNDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Tennessee", displayMode: .inline)
...
struct TNDetailView_Previews: PreviewProvider {
