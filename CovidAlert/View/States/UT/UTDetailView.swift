...
struct UTDetailView: View {
    @ObservedObject var vm = UTDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Utah", displayMode: .inline)
...
struct UTDetailView_Previews: PreviewProvider {
