...
struct VADetailView: View {
    @ObservedObject var vm = VADetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Virginia", displayMode: .inline)
...
struct VADetailView_Previews: PreviewProvider {
