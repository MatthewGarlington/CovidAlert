...
struct VTDetailView: View {
    @ObservedObject var vm = VTDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Vermont", displayMode: .inline)
...
struct VTDetailView_Previews: PreviewProvider {
