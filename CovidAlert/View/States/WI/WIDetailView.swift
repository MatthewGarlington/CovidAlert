...
struct WIDetailView: View {
    @ObservedObject var vm = WIDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Wisconsin", displayMode: .inline)
...
struct WIDetailView_Previews: PreviewProvider {
