...
struct WVDetailView: View {
    @ObservedObject var vm = WVDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("West Virginia", displayMode: .inline)
...
struct WVDetailView_Previews: PreviewProvider {
