...
struct WYDetailView: View {
    @ObservedObject var vm = WYDetailViewModel()
    ...
    var body: some View {
        NavigationView {
            ...
            .cornerRadius(7)
        }.navigationBarTitle("Wyoming", displayMode: .inline)
...
struct WYDetailView_Previews: PreviewProvider {
